<div class="col-lg-12 col-md-12 col-sm-12  rtl " style="background-image:url('/images/bck.jpg');min-height: 846px;">
    {{--<div class="container">--}}
    <div class="col-md-12">
    ...
    <div class="row">
        @if($jobpost->approval == 1)
            ...
            @endforeach
        @elseif($jobpost->approval == 0  )
            <div class="box col-md-7 text-right text-rtl ">
                <div class="box-header"><strong> این آگهی در انتظار تایید مدیر سایت می باشد.</strong></div>
            </div>
        @elseif($jobpost->approval == 2  )
            <div class="box col-md-7">
                <div class="box-header"> این آگهی توسط مدیر سایت غیر قابل انتشار تشخیص داده شد.</div>
            </div>
        @endif
    </div>
