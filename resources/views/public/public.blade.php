                ...
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand">
                        <a href="//{{$company->website}}">
                            <img src="/images/logos/{{$company->logo}}" height="65px"/>
                        </a>
                    </div>
                </div>
                        ...
                        <div class="col-sm-6 pull-right">
                            <div class="carbon-wrap">
                                <div class="carousel-content">
                                    <h2 class="animation animated-item-1">به <span>{{$company->name}}</span> بپیوندید
                                    </h2>
...
<div class="about">
    <div class="container">
        <div class="col-md-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
            <h2>about us</h2>
            <img src="/Company/images/6.jpg" class="img-responsive"/>
...
<div class="lates">
    <div class="container">
        ...
        <div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
            <img src="/Company/images/4.jpg" class="img-responsive"/>
        ...
        <div class="partners">
            <ul>
                <li><a href="#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms"
                                     data-wow-delay="300ms" src="/Company/images/partners/partner1.png"></a></li>
                <li><a href="#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms"
                                     data-wow-delay="600ms" src="/Company/images/partners/partner2.png"></a></li>
                <li><a href="#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms"
                                     data-wow-delay="900ms" src="/Company/images/partners/partner3.png"></a></li>
                <li><a href="#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms"
                                     data-wow-delay="1200ms" src="/Company/images/partners/partner4.png"></a></li>
                <li><a href="#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms"
                                     data-wow-delay="1500ms" src="/Company/images/partners/partner5.png"></a></li>
            </ul>
        </div>
    </div>
    <!--/.container-->
...
<script src="/Company/js/jquery-2.1.1.min.js"></script>
